...
export const contacts: Contact[] = [
  {
    ...
    inputGuide:
      '혹시 지난주 회의 때 말씀하셨던 메타 광고 CTR 데이터 있으실까요? 아 제가 지금 리포트 작업 중인데 반영을 해야 할 것 같아서요.. 근데 혹시 지금 바쁘시면 나중에 여쭤봐도 되는데 가능하시면 지금 확인 부탁드려도 될까요? 죄송합니다ㅠ',
  ...
  },
  {
    ...
    inputGuide:
      '혹시 공유주셨던 디자인 시안 있잖아요..! 보니까 CTA 버튼 컬러가 조금 더 대비 있으면 클릭 유도가 더 잘 될 것 같아서요.!! 혹시 컬러 쪽 한 번만 수정 가능할지 여쭤봐도 될까요??',
  ...
  },
  {
    ...
    inputGuide:
      '주임님 혹시 지난 미팅 때 말씀 나왔던 인플루언서 캠페인 작업 리스트 혹시 공유 가능하실까요? 다음 달 진행 예정이라고 하셔서 미리 확인해두려고 합니다..!',
